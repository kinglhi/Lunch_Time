...
class MenuContentTests : BaseTest() {
    ...
    fun entree_menu_item_content() {
        ...
        launchFragmentInContainer<EntreeMenuFragment>(themeResId = R.style.Theme_LunchTime)
        ...
        Espresso.onView(withId(R.id.chilli))
            .check(ViewAssertions.matches(ViewMatchers.withText(CoreMatchers.containsString("Three Bean Chilli"))))
        Espresso.onView(withId(R.id.chilli_description))
            .check(ViewAssertions.matches(ViewMatchers.withText(CoreMatchers.containsString("Black beans"))))
        Espresso.onView(withId(R.id.chilli_price))
    ...
    fun side_menu_item_content() {
        ...
        launchFragmentInContainer<SideMenuFragment>(themeResId = R.style.Theme_LunchTime)
    ...
    fun accompaniment_menu_item_content() {
        ...
        launchFragmentInContainer<AccompanimentMenuFragment>(themeResId = R.style.Theme_LunchTime)
